...
filter(penguins, sex=="Female" & culmen_length_mm == ">=39mm" & island== "Dream")
...
```{r, message=FALSE, warning=FALSE}
penguins%>%
  group_by(species,island="Biscoe")%>%
  summarize(across(starts_with("culmen_depth_mm"), max na.rm=TRUE))

...
```{r, message=FALSE}
#select 
##creates new data frame, keeping chosen columns, in this case keeping study name all the way to delta keeping out comments
penguins%>%
  select(study_name:delta_13_c_o_oo)

#rename
##lets you rename a chosen column in this case changing island_name to island
penguins%>%

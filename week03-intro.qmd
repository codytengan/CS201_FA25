...
author: "Amber Camp" (edited by cody)  
date: "2025-09-08"
format: html
editor: visual
---
...
tail(mtcars) # displays the top few lines of the dataframe
...
-   How many rows and columns are in the dataframe? 32 rows 12 columns
-   What variables look interesting?
-   How might you view the last few rows of the dataframe with a single function? tail
...
plot(mtcars$cyl, mtcars$hp,
     ...
     main = "Cars with more cylinders produce more horse power")
